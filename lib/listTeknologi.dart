...
class beritaTeknologi extends StatefulWidget {
  @override
  _beritaTeknologiState createState() => _beritaTeknologiState();
}

class _beritaTeknologiState extends State<beritaTeknologi> {
