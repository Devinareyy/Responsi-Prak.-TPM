...
class beritaNasional extends StatefulWidget {
  @override
  _beritaNasionalState createState() => _beritaNasionalState();
}

class _beritaNasionalState extends State<beritaNasional> {
  List<dynamic> newsList = [];
  List<dynamic> filteredNewsList = [];

  Future<void> fetchNewsData() async {
    final response = await http.get(Uri.parse("https://api-berita-indonesia.vercel.app/cnn/nasional"));
